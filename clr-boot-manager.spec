...
Source0  : https://github.com/clearlinux/clr-boot-manager/releases/download/v3.3.1/clr-boot-manager-3.3.1.tar.xz
...
%prep
%setup -q -n clr-boot-manager-3.3.1
cd %{_builddir}/clr-boot-manager-3.3.1
%patch -P 1 -p1
%patch -P 2 -p1
%patch -P 3 -p1
%patch -P 4 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1728686218
