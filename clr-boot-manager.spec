...
Source0  : https://github.com/clearlinux/clr-boot-manager/releases/download/v3.2.12/clr-boot-manager-3.2.12.tar.xz
...
%prep
%setup -q -n clr-boot-manager-3.2.12
cd %{_builddir}/clr-boot-manager-3.2.12
%patch1 -p1
%patch2 -p1
%patch3 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665608655
